defmodule FracomexSynchroWeb.Router do
  use FracomexSynchroWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {FracomexSynchroWeb.LayoutView, :root}
  ...
  # scope "/api", FracomexSynchroWeb do
  #   pipe_through :api
  # end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: FracomexSynchroWeb.Telemetry
    end
  end
