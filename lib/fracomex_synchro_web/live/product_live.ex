defmodule FracomexSynchroWeb.Live.ProductLive do
  use FracomexSynchroWeb, :live_view

  alias FracomexSynchro.Products
  alias FracomexSynchro.Utilities
  ...
  def render(assigns) do
    case assigns.live_action do
      :index ->
        FracomexSynchroWeb.ProductView.render("product_live.html", assigns)
      :family ->
        FracomexSynchroWeb.ProductView.render("family_live.html", assigns)
      :sub_family ->
        FracomexSynchroWeb.ProductView.render("sub_family_live.html", assigns)
      :product_details ->
        FracomexSynchroWeb.ProductView.render("single_product_live.html", assigns)
      :empty_items ->
        FracomexSynchroWeb.ProductView.render("empty_items_live.html", assigns)
      _ ->
        FracomexSynchroWeb.ProductView.render("product_live.html", assigns)
    end
  end
