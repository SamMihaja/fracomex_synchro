defmodule FracomexSynchroWeb.Live.CartLive do
  ...
  def render(assigns) do
    if is_nil(assigns.cart) or assigns.cart == [] do
      FracomexSynchroWeb.CartView.render("cart_empty.html", assigns)
    else
      FracomexSynchroWeb.CartView.render("cart_live.html", assigns)
    end
  end
end
